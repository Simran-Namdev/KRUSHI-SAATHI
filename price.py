...
def index():
    ...
    return render_template('price.html', top_gainers = top_gainers, top_losers = top_losers, six_months_forecast = six_months_forecast, commodities=commodities, chunks=chunks)
@price.route('/commodity/<name>')
